...
- [ ] `portals pair` command creates pairs
- [ ] `portals unpair` command removes pairs
- [ ] `portals list` command shows all pairs
- [ ] `portals sync` works in pair mode
- [ ] `portals watch` works in pair mode
